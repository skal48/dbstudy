...
SELECT V.EMPLOYEE_ID, V.FIRST_NAME, V.LAST_NAME, V.DEPARTMENT_ID, L.LOCATION_ID, L.STREET_ADDRESS
...
-- 2. 사원번호.사원명. 직무번호. 직무이름(JOB TITLE)을 조회하시오 
